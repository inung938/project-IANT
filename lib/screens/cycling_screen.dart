...
class CyclingScreen extends StatefulWidget {
  ...
  const CyclingScreen({super.key, required this.penggunaId});
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      ...
                      if (index == 1) Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => WalkScreen(penggunaId: widget.penggunaId)));
                      if (index == 2) return;
